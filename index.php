   ...
   if(isset($_POST["register"]))
   {
   	...
   	if($error_user_name == '' && $error_user_email == '' && $error_user_password == '')
   	{
   		...
   		if($connect->lastInsertId() == 0)
   		{
   			...
   			$mail->Subject = 'Registration Verification code for Verifying Email Address';
   
   			$message_body = '<p>For verify your email address, enter this verification code when prompted: <b>'.$user_otp.'</b>.</p><p>Sincerely,</p>';
   			...
   			if($mail->Send())
   			{
   				...
   				echo '<script type="text/javascript">window.location="email_verify.php?code='.$user_activation_code.'";</script>';
      ...
      <div class="container">
         ...
         <div class="col-md-6">
            ...
            <div style="display: flex;width: 100%;position: relative;">
               <div style="padding-right: 15px;"><b><a href="resend_email_otp.php">Resend Activation OTP?</a></b></div>
            </div>
         </div>
      </div>
      <br />
