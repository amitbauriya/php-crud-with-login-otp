...
if(isset($_POST["action"]))
{
    ...
    $success = 'Note: Using server mail to send all emails to your inbox sometime take time but you will receive shortly, the login otp on ur mail will be: '.$login_otp;
	if($_POST["action"] == "otp")
	{
		if($_POST["user_otp"] != '')
		{
